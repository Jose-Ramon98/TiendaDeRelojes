package com.relojes.Controller.util.paginator;
...
public class PageRender <T> {//con la t decimos que es generico

	
	private String url;
	
	private Page<Relojes> page;
	...
	public PageRender(String url, Page<Relojes> page) {
		super();
		this.url = url;
		this.page = page;
	...
	public Page<Relojes> getPage() {
		return page;
	}

	public void setPage(Page<Relojes> page) {
		this.page = page;
	}
